...
export function Footer() {
  return (
    <footer className="bg-resilium-dark py-12 text-[#F5F7FA]">
      <div className="section-shell">
        ...
        <p className="pt-8 text-sm leading-7 text-white/[0.52]">
          Resilium je součástí širšího systému praktického tréninku odolnosti, rozhodování a osobní bezpečnosti.
        </p>
      </div>
    </footer>
  );
